...
This folder contains everything needed to implement Ledger.
...
- `instructions/incremental/` - 6 milestone instructions (foundation, then sections)
...
5. Answer the agent's clarifying questions about auth, data modeling, etc.
