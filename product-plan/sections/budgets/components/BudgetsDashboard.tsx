...
export function BudgetsDashboard({
  ...
  // Combine and sort all budgets and goals into a flat list
  ...
  const handleSave = (id: string, updates: Partial<Budget> | Partial<Goal>) => {
    if (selectedBudget) {
      onEditBudget?.(id, updates as Partial<Budget>)
    } else if (selectedGoal) {
      onEditGoal?.(id, updates as Partial<Goal>)
    }
  }
